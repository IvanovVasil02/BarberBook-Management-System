...
<body id="home" data-bs-spy="scroll" data-bs-target=".navbar">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    ?>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="modal" data-bs-target="#mioCalendario">Calendar</a>
                        </li>
                    <?php
                    }
                    ?>
    ...
    <section id="hero">
        <div class="container">
            <div class="row pic">
                <div class="col-lg-6 mt-lg-5 mt-sm-5">
                    ...
                    <a href="#"><button type="button" class="btn btn-brand mt-lg-5 mt-sm-5" data-bs-toggle="modal" data-bs-target="#calendario">Book now!</button></a>

                    <?php if (AdminLoggedIn()) { ?>
                        <a href="#"><button type="button" class="btn btn-outline-brand mt-lg-5 mt-sm-5" data-bs-toggle="modal" data-bs-target="#mioCalendario">Calendar</button></a>
                    <?php
                    }
                    ?>
                </div>
